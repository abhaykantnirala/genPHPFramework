...
if (file_exists(SYSTEMPATH . 'drivers/' . $GLOBALS['DB']['mysqli']['DB_DRIVER'] . '/mysqlidrivers.php')) {
    require_once(SYSTEMPATH . 'drivers/' . $GLOBALS['DB']['mysqli']['DB_DRIVER'] . '/mysqlidrivers.php');
}

if (file_exists(SYSTEMPATH . 'drivers/' . $GLOBALS['DB']['mysqli']['DB_DRIVER'] . '/imysqlimodels.php')) {
    require_once(SYSTEMPATH . 'drivers/' . $GLOBALS['DB']['mysqli']['DB_DRIVER'] . '/imysqlimodels.php');
}

class mysqlimodels extends mysqlidrivers implements imysqlimodels {
    ...
    public function gettablefieldslist($table_name) {
        ...
        $this->sql_command = "SHOW FULL COLUMNS FROM `" . $table_name . "` FROM `" . $this->DATABASE . "`";
