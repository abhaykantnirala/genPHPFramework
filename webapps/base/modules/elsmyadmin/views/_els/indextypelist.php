...
<div class="row">
    <h2 class="padding_left_15">Types</h2>
    <br><br>
    <div class="col-md-4">
        <table>
            <tr class="index-head">
            ...
            <?php
            foreach ($indextypelist as $row) {
                $row = (array) $row;
                ?>
                <tr>
                    <td>Actions</td>
                    <td><a href="javascript:void(0)" onclick="showtypelist('<?php //echo $row['index']; ?>')"><?php //echo $row['index']; ?></a></td>
            ...
            <?php } ?>
            <?php if ($total = count($indextypelist)) { ?>
                <tr>
                    <td></td>
