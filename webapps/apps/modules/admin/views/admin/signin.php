...
<html lang="en">
    ...
    <head>
        ...
        <![endif]-->
        <script src="<?php echo $this->helper->url->baseurl('public/admin/plugins/nprogress/nprogress.js');?>"></script>
    </head>
                    ...
                    <div class="card card-default mb-0">
                        <div class="card-header pb-0">
                            <div class="app-brand w-100 d-flex justify-content-center border-bottom-0">
                                <a class="w-auto pl-0" href="<?php echo $this->helper->url->baseurl('admin-dashboard');?>">
                                    <img src="<?php echo $this->helper->url->baseurl('public/admin/images/logo.png');?>" alt="Logo">
                        ...
                        <div class="card-body px-5 pb-5 pt-0">
                            ...
                            <form action="<?php echo $this->helper->url->baseurl('admin-login');?>" method="post">
                                <div class="row">
                                    <div class="form-group col-md-12 mb-4">
                                        <input type="email" class="form-control input-lg" id="aemail" name="aemail" aria-describedby="emailHelp"
                                               placeholder="email">
                                    </div>
                                    <div class="form-group col-md-12 ">
                                        <input type="password" class="form-control input-lg" id="apwd" name="apwd" placeholder="Password">
                                    </div>
                                    <div class="col-md-12">
