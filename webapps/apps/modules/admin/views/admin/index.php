        ...
        <div class="row">
            <div class="col-xl-4">
                ...
                <div class="card card-default">
                    <div class="card-header">
                        <h2>Top <?php echo count($top_users_info);?> Customers</h2>
                        <span style="color:blue;">Total: <?php echo $top_users_info[0]->tot_users;?></span>
                    </div>
                    <div class="card-body">
                        <table class="table table-borderless table-thead-border">
                            <thead>
                                <tr>
                                    <th>User Name</th>
                                    <th class="text-right">EMI Received</th>
                                </tr>
                            </thead>
                            <tbody>
                                <?php foreach($top_users_info as $row){?>
                                <tr>
                                    <td class="text-dark font-weight-bold"><?php echo $row->user_name;?></td>
                                    <td class="text-right"><?php echo $this->helper->common->currency_format($row->income); ?></td>
                                </tr>
                                <?php }?>
                            </tbody>
            ...
            <div class="col-xl-8">
                <div class="row">
                	<div class="col-xl-12">
		                <div class="card card-default">
		                    <?php $tot_emi=0; foreach($planwise_info as $info){
		                        $tot_emi += $info->total_emi_received;
		                    }?>
		                    <div class="card-header">
		                        <h2>Plan Wise Details - <?php echo $this->helper->common->currency_format($tot_emi);?></h2>
		                    ...
		                    <div class="card-body py-0" >
		                        <div class="row">
		                        <?php foreach ($planwise_info as $info) { ?>
		                        <div class="col-xl-6 col-sm-6" style="height:160px;">
		                            <div class="card card-default card-mini">
		                                <div class="card-header">
		                                    <h5><span style="color:blue;"><?php echo $info->plan_name; ?> - </span><?php echo $this->helper->common->currency_format($info->plan_amount); ?></h5>
		                                    <div class="sub-title">
		                                        <span class="mr-1">Plan EMI</span> :
		                                        <span class="mx-1"><?php echo $this->helper->common->currency_format($info->plan_emi); ?></span>
		                                    </div>
		                                    <div class="sub-title">
		                                        <span class="mr-1">Users</span> |
		                                        <span class="mx-1"><?php echo $info->tot_users; ?></span>
		                                        <i class="mdi mdi-arrow-up-bold text-success"></i>
		                                    </div>
		                                    <div class="sub-title">
		                                        <span class="mr-1">EMI Received</span> |
		                                        <span class="mx-1"><?php echo $this->helper->common->currency_format($info->total_emi_received); ?></span>
		                                        <i class="mdi mdi-arrow-up-bold text-success"></i>
		                                    </div>
		                                </div>
		                            </div>
                ...
                <!-- Top Customers -->
		                <div class="card card-default">
		                    <div class="card-header">
		                        <h2>Recent <?php echo count($recent_users_info);?> Customers</h2>
		                    </div>
		                    <div class="card-body">
		                        <table class="table table-borderless table-thead-border">
		                            <thead>
		                            ...
		                            <tbody>
		                                <?php foreach($recent_users_info as $row){?>
		                                <tr>
		                                    <td class="text-dark font-weight-bold"><?php echo $row->user_name;?></td>
		                                    <td class="text-right"><?php echo date('d M, Y', strtotime($row->datetime)); ?></td>
		                                </tr>
		                                <?php }?>
		                            </tbody>
		                        </table>
                        ...
                        <div class="card-body">
                            <table id="productsTable" class="table table-hover table-product" style="width:100%">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td class="py-0">
                                            <img src="<?php echo $this->helper->url->baseurl('public/admin/images/products/products-xs-01.jpg'); ?>" alt="Product Image">
                                        </td>
                                        <td>Coach Swagger</td>
                                        <td>24541</td>
                                        <td>27</td>
                                    ...
                                    <tr>
                                        <td class="py-0">
                                            <img src="<?php echo $this->helper->url->baseurl('public/admin/images/products/products-xs-02.jpg'); ?>" alt="Product Image">
                                        </td>
                                    ...
                                    <tr>
                                        <td class="py-0">
                                            <img src="<?php echo $this->helper->url->baseurl('public/admin/images/products/products-xs-03.jpg'); ?>" alt="Product Image">
                                        </td>
                                    ...
                                    <tr>
                                        <td class="py-0">
                                            <img src="<?php echo $this->helper->url->baseurl('public/admin/images/products/products-xs-04.jpg'); ?>" alt="Product Image">
                                        </td>
                                    ...
                                    <tr>
                                        <td class="py-0">
                                            <img src="<?php echo $this->helper->url->baseurl('public/admin/images/products/products-xs-05.jpg'); ?>" alt="Product Image">
                                        </td>
                                    ...
                                    <tr>
                                        <td class="py-0">
                                            <img src="<?php echo $this->helper->url->baseurl('public/admin/images/products/products-xs-06.jpg'); ?>" alt="Product Image">
                                        </td>
                                        <td>Olay</td>
                                        <td>24546</td>
                                        <td>19</td>
                                    ...
                                    <tr>
                                        <td class="py-0">
                                            <img src="<?php echo $this->helper->url->baseurl('public/admin/images/products/products-xs-07.jpg'); ?>" alt="Product Image">
                                        </td>
                                        <td>Ledger Nano X</td>
                                        <td>24547</td>
                                        <td>61</td>
                                    ...
                                    <tr>
                                        <td class="py-0">
                                            <img src="<?php echo $this->helper->url->baseurl('public/admin/images/products/products-xs-08.jpg'); ?>" alt="Product Image">
                                        </td>
                                    ...
                                    <tr>
                                        <td class="py-0">
                                            <img src="<?php echo $this->helper->url->baseurl('public/admin/images/products/products-xs-09.jpg'); ?>" alt="Product Image">
                                        </td>
                                    ...
                                    <tr>
                                        <td class="py-0">
                                            <img src="<?php echo $this->helper->url->baseurl('public/admin/images/products/products-xs-10.jpg'); ?>" alt="Product Image">
                                        </td>
                                        <td>Wattbike Atom</td>
                                        <td>24550</td>
                                        <td>61</td>
                                    ...
                                    <tr>
                                        <td class="py-0">
                                            <img src="<?php echo $this->helper->url->baseurl('public/admin/images/products/products-xs-11.jpg'); ?>" alt="Product Image">
                                        </td>
                                        <td>Smart Watch</td>
                                        <td>24551</td>
                                        <td>19</td>
                                    ...
                                    <tr>
                                        <td class="py-0">
                                            <img src="<?php echo $this->helper->url->baseurl('public/admin/images/products/products-xs-12.jpg'); ?>" alt="Product Image">
                                        </td>
                                    ...
                                    <tr>
                                        <td class="py-0">
                                            <img src="<?php echo $this->helper->url->baseurl('public/admin/images/products/products-xs-13.jpg'); ?>" alt="Product Image">
                                        </td>
                                    ...
                                    <tr>
                                        <td class="py-0">
                                            <img src="<?php echo $this->helper->url->baseurl('public/admin/images/products/products-xs-14.jpg'); ?>" alt="Product Image">
                                        </td>
                                    ...
                                    <tr>
                                        <td class="py-0">
                                            <img src="<?php echo $this->helper->url->baseurl('public/admin/images/products/products-xs-15.jpg'); ?>" alt="Product Image">
                                        </td>
                                        <td>Headphones</td>
                                        <td>24555</td>
                                        <td>17</td>
                    ...
                    <div class="card card-default chat">
                        <div class="card-header">
                            ...
                            <div class="dropdown dropdown-chat-state">
                                ...
                                <ul class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuButton">
                                    ...
                                    <li>
                                        <a href="#" class="user-link">
                                            <img src="<?php echo $this->helper->url->baseurl('public/admin/images/user/user-sm-02.jpg'); ?>" alt="User Image">
                                    ...
                                    <li>
                                        <a href="#" class="user-link">
                                            <img src="<?php echo $this->helper->url->baseurl('public/admin/images/user/user-sm-03.jpg'); ?>" alt="User Image">
                                            <span class="username">riman Ghose
                                                <span class="badge badge-secondary">18</span>
                                            </span>
                                            <span class="state">
                                    ...
                                    <li>
                                        <a href="#" class="user-link">
                                            <img src="<?php echo $this->helper->url->baseurl('public/admin/images/user/user-sm-04.jpg'); ?>" alt="User Image">
                                            <span class="username">riman Ghose
                                                <span class="badge badge-secondary">18</span>
                                            </span>
                                            <span class="state">
                                    ...
                                    <li>
                                        <a href="#" class="user-link">
                                            <img src="<?php echo $this->helper->url->baseurl('public/admin/images/user/user-sm-05.jpg'); ?>" alt="User Image">
                        ...
                        <div class="card-body pb-0" data-simplebar style="height: 363px;">
                            ...
                            <div class="media media-chat">
                                <img src="<?php echo $this->helper->url->baseurl('public/admin/images/user/user-sm-01.jpg'); ?>" class="rounded-circle" alt="Avata Image">
                            ...
                            <div class="media media-chat media-chat-right">
                                ...
                                <img src="<?php echo $this->helper->url->baseurl('public/admin/images/user/user-sm-02.jpg'); ?>" class="rounded-circle" alt="Avata Image">
                            </div>
